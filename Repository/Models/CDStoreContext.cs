...
namespace Repository.Models
{
    public partial class CDStoreContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=KHANGMINH\\SQLEXPRESS;uid=sa;pwd=12345;database=CDStore;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActivityLog>(entity =>
            {
                entity.HasKey(e => e.ActivityId)
                    .HasName("PK__Activity__0FC9CBECA0DCE378");
            ...
            modelBuilder.Entity<Cdalbum>(entity =>
            {
                entity.HasKey(e => e.AlbumId)
                    .HasName("PK__CDAlbum__75BF3ECF22D94AFD");
            ...
            modelBuilder.Entity<CustomerRequest>(entity =>
            {
                entity.HasKey(e => e.RequestId)
                    .HasName("PK__Customer__E3C5DE315E43556B");
