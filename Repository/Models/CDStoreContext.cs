    ...
    public partial class CDStoreContext : DbContext
    {
        ...
        private string GetConnectionString()
        {
            IConfiguration config = new ConfigurationBuilder()
                ...
                .Build();
            var strConn = config["ConnectionStrings:CDDatabase"];
            return strConn;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActivityLog>(entity =>
            {
                entity.HasKey(e => e.ActivityId)
                    .HasName("PK__Activity__0FC9CBEC9BE72F93");
                ...
                entity.HasOne(d => d.Account)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ActivityL__accou__300424B4");

                entity.HasOne(d => d.Album)
                    .WithMany(p => p.ActivityLogs)
                    .HasForeignKey(d => d.AlbumId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ActivityL__album__30F848ED");

                entity.HasOne(d => d.Request)
                    .WithMany(p => p.ActivityLogs)
                    .HasForeignKey(d => d.RequestId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ActivityL__reque__31EC6D26");
            });

            modelBuilder.Entity<Cdalbum>(entity =>
            {
                entity.HasKey(e => e.AlbumId)
                    .HasName("PK__CDAlbum__75BF3ECF3D9A81BC");
            ...
            modelBuilder.Entity<CustomerRequest>(entity =>
            {
                entity.HasKey(e => e.RequestId)
                    .HasName("PK__Customer__E3C5DE3141AA8360");
